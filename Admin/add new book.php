        ...
        <main>
            <div class="container">
                ...
                <div class="col-sm"></div>
                    <div class="col-sm-14">
                    <form action="handler/add book handler.php" method="post" enctype="multipart/form-data" onsubmit="validate(this)">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Title" id="title" name="title" name="title">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" id="cover-image" name="file" placeholder="Image">
                            </div>
                        </div>
                        <div class="col-sm-10">
